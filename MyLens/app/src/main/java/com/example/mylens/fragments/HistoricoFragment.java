...
public class HistoricoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ListView listView = (ListView) view.findViewById(R.id.list_lentes);
        dao = new LenteDAO(getActivity());
        lentes = dao.obterTodos();
        lentesFiltradas.addAll(lentes);

        ArrayAdapter<Lente> adaptador = new ArrayAdapter<Lente>(getActivity(), android.R.layout.simple_list_item_1, lentes);
